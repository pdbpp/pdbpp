...
curl -S -L --connect-timeout 5 --retry 6 -s -o /tmp/codecov.sh https://raw.githubusercontent.com/codecov/codecov-bash/6329481eb0b26ed755524738240b3e381cdfb76d/codecov
